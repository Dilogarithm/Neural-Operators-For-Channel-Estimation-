...
class SFT_FNO(nn.Module):
    def __init__(self, hidden_channels=64):
        ...
        # learnable weight for correction
    ...
    def forward(self, R):
        ...
        H_c = self.fno(x) # No structure formulation
...
def train_model(model, noise_std, NR, NT, K, rho, device, F, W, GL, GR, steps=500):
...
def evaluate_model(model, noise_std, NR, NT, K, rho, device, F, W, GL, GR):
    ...
    return nmse_model / N, nmse_avg / N, nmse_ls / N
